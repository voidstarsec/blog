---
layout: post
title: Ghidra Scripting, PCode Emulation, and Password Cracking
description: A Free Ghidra course, sponsored by Hack-a-Day
summary: In this post, I want to demonstrate and explain the following, Using pre-existing Ghidra scripts to aid in your analysis, Writing your own scripts to automate analysis tasks,Utilize and emulate Ghidra's intermediate language PCode to aid in your analysis
author: "Matthew Alt"
tags: tutorial,ghidra
category: Ghidra
slug: ghidra-pcode
---
...
* If you would like to follow along, you will need to get your [Ghidra development environment set up correctly](https://voidstarsec.com/blog/ghidra-debugger).
...
We can see from this assembly snippet that the first four characters are being passed through ```r0```-```r3```. The other three characters are passed in on the stack. We can set a breakpoint using [our gdb setup from the previous post](https://voidstarsec.com/blog/ghidra-debugger/) and dump the register/stack content to verify this. Here is the register/stack content with 7 ```G```'s are entered:
...
If you would like to learn more about Ghidra, check out [this free course](https://hackaday.io/course/172292-introduction-to-reverse-engineering-with-ghidra) that I  put together with HackadayU.

If you're interested in [hardware security training](https://voidstarsec.com/#training) at your organization, please don't hesitate to [contact us](https://voidstarsec.com/#contact). We also have a self-paced training available [here](https://voidstarsecurity.thinkific.com/)
